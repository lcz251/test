...
---
### 2024/9/21
- working youtube and tg
- j1800 sold in xianyu,include 4g and msata
- xiaosaurus update too much
- sqlite
---
### 2024/9/22
- python pandas numpy 
- freertos
- 51job and stm32 c char **name,*ste[]
- python bibaohansh python bibaohanshuu
---
### 2024/9/23
- xiaosaurus download
- work do it to docx
...
### 2024/9/24
- js
- pcb 51 stm32 esp32 cortax arm
- king gong hou bo zi nan
- python os module: import os
	- os.listdir('path')
    - os.mkdir('dir')  os.mkdirs('path/xx')
    - os.rmdir('dir') os.rmsdirs('parh/dir')
    - os.chdir()
 	- os.getcwd()
    - os.rename()
    - os.remove()
    ...
    - os.path.abspath
 	- os.path.join
    - os.path.split os.path.spiltext
    - os.path.isdir os.path.isfile()
    - os.path.getsize() os.path.getmtime()
---
### 2024/9/25
- qq  music python
- 12306 buy ticket by c
- fnnas.com
- argv
---
### 2024/9/26
- earn money less than last year
- re tkinter csv turtle os
- 121 0 -121 by python
- pyinstaller c micro
---
### 2024/9/27
...
- embedem 
- python package lib init too much
- mfc vs qt qume docker k8s
---
### 2024/9/28
- front to do something that need to be slove it
- openwrt 
- html css js is easy but technoque
- t-box vechive
---
### 2024/9/29
- uds autosar
- python modules inline such as re os sys other is not ness
- sqlite php node.js html for signel develop
- higher need more time to do we do basic technolg runoob
---
### 2024/9/30
- content is large but no action
- hardware is enough software is short
- top app servers  
- front server
---
#### BOT    
