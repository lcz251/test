...
- pyinstaller
- kernel 
- x86 linux server or development ,much things limited
---
### 2024/10/22
- lwt website need code changed where to coding and debug
- 51stc and stm32 pico pi jd double 11
- w3school openwrt linux
- mouse,keyboard,jumper n100 server
---
### 2024/10/23
- flask  
- dash python and shell
- github . 。
- shell command
---
### 2024/10/24
- 1024 programer's day 1k 
- machine 
- linux and python at reno 4
- html css js work at reno 8
---
### 2024/10/25
- x86 on work python, package include turtle tkinter csv json re xml urllib webbrowser
- tobe deal
- tobe deal
- tobe deal
---
### 2024/10/26
- python pandas as pd
- pd.Series([1,2,3,4],indwx=[])
- data={x:xx} df=pd.DataFrame(data)
- df[] df.loc[] df.iloc[]
- pd.read_csv() pd.to_csv() same as sql excel
---
### 2024/10/27
- multiprocessing 
...
- Pool map
- multiproceasing.Value(i,0)  an Arrmy
---
### 2024/10/28
- elf 
- file test
- readelf -h test  :readelf -l test -S -g
- hexdunp -C -n 64 test
- objdump -d text
- ldd test
---
...
- conn.commit
- cursor.fetchall()
- with:https://mp.weixin.qq.com/s/L8Mq05iT0Jeq-NDUlBev1g 
---
### 2024/10/30
- hashlib.sha256(password.encode()).hexdigest()
- pthread in c posix
- python c code 
	- list and tuple:pointer size allocate
    - any and all:o(n)
    - strings:
    - class 
    - float
    ...
    - dict
    - value or pointer
- python migical function __func__():
---
### 2024/10/31
- x in str
- str.find(x)
...
- re.sub(xp,rx,str)
- re.split(xp,str)
- re.compile(xp).findall(str)
- re.findall(re.escape(xp),str)
---
#### BOT    
this is the buttom   
[top](#top)
